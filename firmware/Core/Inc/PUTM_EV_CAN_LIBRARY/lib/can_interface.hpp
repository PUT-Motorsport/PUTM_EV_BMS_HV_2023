...
class Can_interface {
  ...
  Device<Lap_timer_Skidpad_time> laptimer_skidpad{LAP_TIMER_SKIDPAD_TIME_CAN_ID};
...
public:
  ...
  Lap_timer_Skidpad_time get_laptimer_skidpad_time() { return laptimer_skidpad.data; }
  ...
  bool get_laptimer_skidpad_new_data() { return laptimer_skidpad.get_new_data(); }
